...
export default function Landing() {
    ...
    <h1>PARTICIPANT INFORMATION SHEET </h1><br /><br />
    <p style = {{ textAlign: 'left'}}>
<h2>Chameleon – A virtual standardised patient</h2><br />
<h5>Principal Investigator(s): Al-Hussein Abutaleb</h5>
<h5>Supervisor(s): Dr. Bruno Yun</h5><br />
<p style = {{ textAlign: 'left'}}>
...
<br />
    ...
    <div class="col align-self-center">
        <button type="submit" class="btn btn-primary btn-lg" onClick={handleClick}>Agree and begin experiment</button><br /><br /><br /><br /><br />
